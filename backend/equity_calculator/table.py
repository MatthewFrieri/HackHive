...
from equity_calculator.exceptions import *
from equity_calculator.utils import *
from equity_calculator.hand import Hand
from equity_calculator.ranker import *
...
class Table:
    ...
    def next_round(self, cards, verbose=True):
